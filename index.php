...
// Search/Filter (Optional - សម្រាប់ Hero Search Bar)
$search = $_GET['search'] ?? '';
...
// ទាញយកទីតាំងទាំងអស់ សម្រាប់ Dropdown Filter
...
<section id="home" class="relative overflow-hidden bg-gradient-to-br from-indigo-700 via-blue-700 to-purple-700 hero-blob">
    ...
    <div class="max-w-6xl mx-auto px-6 py-24 md:py-32 relative z-10">
        ...
        <!-- Search Bar -->
        <form method="GET" action="index.php" class="bg-white rounded-xl md:rounded-full shadow-2xl p-2 flex flex-col md:flex-row gap-2 max-w-3xl">
...
<footer class="bg-gray-900 text-gray-400 py-10 px-6 text-center text-sm">
    <div class="flex items-center justify-center gap-2 text-white font-bold text-lg mb-4">
